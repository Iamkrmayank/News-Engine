...
REM Push to ACR (uncomment when ready)
REM echo ℹ️  Pushing image to ACR: %FULL_IMAGE_NAME%
REM docker push %FULL_IMAGE_NAME%
REM if errorlevel 1 (
REM     echo ❌ Failed to push image to ACR!
REM     pause
REM     exit /b 1
REM )
REM echo ✅ Image pushed to ACR successfully!
...
echo.
echo ℹ️  To push to ACR (uncomment the push commands in this script):
echo ℹ️    az acr login --name %ACR_NAME%
echo ℹ️    docker push %FULL_IMAGE_NAME%
echo.
